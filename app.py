...
def chat():
    ...
    try:
        ...
        if "401" in error_msg or "invalid_api_key" in error_msg.lower():
            bot_reply = "Authentication Error: Your Groq API key is invalid or unauthorized. Please check your .env file."
        else:
            bot_reply = f"Sorry, an error occurred while processing your request: {error_msg}"
